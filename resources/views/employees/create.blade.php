              ...
              <div class="card p-4">
                  ...
                  <form method="POST" action="/employees/store" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="first_name" class="form-control" id="first_name" placeholder="Enter First Name" name="first_name" value="{{ old('first_name') }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="last_name" class="form-control" id="last_name" placeholder="Enter Last Name" name="last_name" value="{{ old('last_name') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row g-3 align-items-center">
                            ...
                            @if(isset($countries) && count($countries) )
                              @foreach($countries as $item)
                                <option value="{{$item->phone_code}}"
                                  @if(old('phone_code')==$item->phone_code)
                                    {{ 'selected' }}
                                  @endif
                                >
                        ...
                        <div class="col-auto">
                          <input type="phone_number" class="form-control" id="phone_number" placeholder="Enter phone_number" name="phone_number" value="{{ old('phone_number') }}">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="address" placeholder="Enter Address" name="address" class="form-control" rows="4">{{ old('address') }}</textarea>
